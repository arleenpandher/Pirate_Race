const HardGame = require("./easygame.js");


function HardGameView(ctx, canvas, game, flagctx, scorectx) {
    this.game = game
    this.drawing = ctx 
    this.canvas = canvas
    this.flag = flagctx 
...
HardGameView.prototype.appear = function() {
    // this.scoredisplay()
    let dir = this.game.directions[0]
    dir.display(this.drawing)
}

HardGameView.prototype.disappear = function() {
    let dir = this.game.directions[0]
    dir.discard(this.drawing)
    this.game.directions.shift()
}

HardGameView.prototype.dir = function() {
...
HardGameView.prototype.keydown = function() {
...
HardGameView.prototype.scoredisplay = function() {
...
HardGameView.prototype.click = function() {
