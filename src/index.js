...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    // gameview.key()
    // gameview.game.scoredisplay(ctx)
    ...
    //         setTimeout(appear, 3000+(3000*i) + 1000)
