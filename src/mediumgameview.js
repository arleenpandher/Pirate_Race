...
function MediumGameView(ctx, canvas, game, flagctx, scorectx) {
    this.game = game
    this.drawing = ctx 
    this.canvas = canvas
    this.flag = flagctx 
...
MediumGameView.prototype.appear = function() {
    // this.scoredisplay()
    let dir = this.game.directions[0]
    dir.display(this.drawing)
}

MediumGameView.prototype.disappear = function() {
    let dir = this.game.directions[0]
    dir.discard(this.drawing)
    this.game.directions.shift()
}

MediumGameView.prototype.dir = function() {
...
MediumGameView.prototype.keydown = function() {
...
MediumGameView.prototype.scoredisplay = function() {
...
MediumGameView.prototype.click = function() {
...
MediumGameView.prototype.end = function() {
